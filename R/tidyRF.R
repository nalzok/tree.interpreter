...
#'   \describe{
#'     \item{\code{nclasses}}{An integer. For classification trees, number of
#'       classes of the response. For regression trees, this field will always
#'       be 1.}
#'     \item{\code{ntrees}}{An integer. Number of trees.}
